...
func (d DamageMetric) Evaluate(world *core.World, actor *core.Actor, action core.Action, _ grid.Position, affected []grid.Position) map[string]int {
	enemyDamage := 0
	friendlyFire := 0
	killPotential := 0
...
func calculateExpectedDamage(_ *core.Actor, action core.Action, target *core.Actor, baseDamage int) int {
